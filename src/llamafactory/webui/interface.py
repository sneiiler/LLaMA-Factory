...
def run_web_ui() -> None:
    ...
    print("Visit http://ip:port for Web UI, e.g., http://127.0.0.1:11400")
    fix_proxy(ipv6_enabled=gradio_ipv6)
    create_ui().queue().launch(share=gradio_share, server_name=server_name, inbrowser=True, server_port=11400)
